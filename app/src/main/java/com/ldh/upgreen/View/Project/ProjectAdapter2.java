...
public class ProjectAdapter2 extends RecyclerView.Adapter<ProjectAdapter2.ViewHolder> {
    ...
    public ProjectAdapter2(Context context, ArrayList<Project> projects, ProjectClickListener click) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new ViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.project_item_1, parent, false));
    }
        ...
        public ViewHolder(@NonNull View v) {
            ...
            v.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    _click.onMyProjectClick(getAdapterPosition());
                }
            });
        }
    }
